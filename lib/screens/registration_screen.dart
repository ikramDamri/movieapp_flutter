...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final firstNameField = TextFormField(
        ...
        decoration: InputDecoration(
          prefixIcon: Icon(Icons.account_circle, color: Style.Colors.secondColor),
    ...
    final emailField = TextFormField(
        ...
        textInputAction: TextInputAction.next,
        decoration: InputDecoration(
          prefixIcon: Icon(Icons.mail, color: Style.Colors.secondColor),
          contentPadding: EdgeInsets.fromLTRB(20, 15, 20, 15),
          hintText: "Email",
          hintStyle: TextStyle(color: Style.Colors.secondColor),
          enabledBorder: OutlineInputBorder(
    ...
    final passwordField = TextFormField(
        ...
        textInputAction: TextInputAction.next,
        decoration: InputDecoration(
          prefixIcon: Icon(Icons.vpn_key, color: Style.Colors.secondColor),
          contentPadding: EdgeInsets.fromLTRB(20, 15, 20, 15),
          hintText: "Password",
          hintStyle: TextStyle(color: Style.Colors.secondColor),
          enabledBorder: OutlineInputBorder(
  ...
  postDetailsToFirestore() async {
    ...
    UserModel userModel = UserModel(email: '', firstName: '', secondName: '', uid: '',);
